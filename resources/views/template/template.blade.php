    ...
    <nav class="navbar  fixed-top justify-content-between">
        ...
        <div class="dropdown">
            ...
            data-bs-toggle="dropdown">
                ...
                <span class="d-none d-lg-inline-flex" style="color: white">Feliciano Fuca</span>
            </a>
    ...
    <div class="sidebar pb-3" style="margin-top: 86px;">
        <nav class="sidebar container-fluid d-flex flex-column flex-shrink-0 p-3 " style="width: 260px; margin-top:86px; height: auto;">
            <div class="d-flex align-items-center ms-4 mb-4" style="padding-top: 15px;">
                ...
                <div class="ms-3">
                    <h6 class="mb-0" style="color: white">Feliciano Fuca</h6>
            ...
            <ul class="nav nav-pills flex-column mb-auto">
              ...
              <li>
                <a href="" class="nav-link link-dark">
                    <img class="me-lg-2" src="http://127.0.0.1:8000/assets/img/icons8_teacher_100px.png" alt="" style="width: 40px; height: 40px;">
                    <span class="d-none d-lg-inline-flex" style="color: white">Professores</span>              
                </a>
              </li>
              <li>
                <a href="#" class="nav-link link-dark">
